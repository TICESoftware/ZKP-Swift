...
class ZKPProver {
    ...
    internal func createChallengeRequestDataSDJWT(jwt: String) throws -> ChallengeRequestData {
    ...
    internal func answerChallengeSDJWT(ephemeralPublicKey: ECPublicKey, jwt: String) throws -> String {
        let parsedSDJWT = try parseSDJWT(jwt: jwt)
