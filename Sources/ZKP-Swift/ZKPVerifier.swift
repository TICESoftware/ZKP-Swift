...
public class ZKPVerifier {
    ...
    public func createChallenge(requestData: ChallengeRequestData) throws -> (ECPublicKey, ECPrivateKey) {
    ...
    public func verifyChallengeSDJWT(jwt: String, key: ECPrivateKey) throws -> Bool {
    ...
    public func verifyChallengeMDOC(mdoc: String, key: ECPrivateKey) throws -> Bool {
    ...
    public func verifyChallengeMDOC(issuerAuth: IssuerAuth, key: ECPrivateKey) throws -> Bool {
